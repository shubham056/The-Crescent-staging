        ...
        <Container>
              ...
              <Col col={6} md={6} className="text-area">
                <div className="inner-txt">
                  ...
                  <div className="content_new">{this.state.content} <a href="emailto:tccustomer@crescent.com">tccustomer@crescent.com</a> to sign up and click <a href={announcepdf}>here</a> to view class times.</div >
